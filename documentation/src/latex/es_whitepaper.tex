...
\begin{itemize}
    ...
    $$
    \item Trim of extra empty spaces, eg.$$
    ...
    \item Mapping with a dictionary, eg. $$
        \left.
            \begin{array}{r}
                \texttt{AV} \\
                \texttt{AVE} \\
...
\begin{example}
    Let $$\left\{
        \begin{array}{l}
            d_1^\varsigma \gets \texttt{1600, Pennsylvania Avenue NW.} \\ \\
            d_2^\varsigma \gets \texttt{1600 PENNSYLVANIA AV NW} \\
        \end{array}
    \right.$$
